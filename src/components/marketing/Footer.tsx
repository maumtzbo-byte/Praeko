    ...
    <footer className="border-t border-[var(--hairline)]">
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 px-6 py-16 sm:grid-cols-[1.3fr_1fr_1fr]">
        <div className="flex flex-col gap-3">
          <span className="text-lg font-semibold tracking-[0.2em] text-zinc-950 dark:text-white">PRAEKO</span>
        ...
        <div className="flex flex-col gap-3">
          ...
          <a
            href="mailto:soporte@praeko.com"
            className="text-sm text-zinc-600 transition-colors hover:text-zinc-950 dark:text-zinc-400 dark:hover:text-white"
          >
            soporte@praeko.com
          </a>
      ...
      <div className="border-t border-[var(--hairline)]">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-4 px-6 py-6 sm:flex-row sm:justify-between">
          ...
          <Link
            href="/registro"
            className="btn-shine rounded-full bg-zinc-950 px-4 py-2 text-xs font-medium text-white transition-transform hover:scale-[1.03] dark:bg-white dark:text-zinc-950"
          >
            Empieza gratis
          </Link>
        </div>
