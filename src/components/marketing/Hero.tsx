...
export default function Hero() {
  return (
    ...
    <section className="relative flex min-h-[92vh] flex-col justify-center overflow-hidden bg-[var(--background)] py-24 sm:min-h-[100vh] sm:flex-row sm:items-center sm:py-0">
      ...
      <HeroProtagonista className="pointer-events-none order-2 mx-auto mt-10 aspect-[802/1100] h-72 sm:absolute sm:bottom-0 sm:-right-8 sm:order-none sm:mx-0 sm:mt-0 sm:h-[78%] lg:right-0 lg:h-[94%]" />
    </section>
  );
}
